      ...
      <div className="glass-card animate-fade-in" style={{ width: '100%', maxWidth: 460, padding: '40px 36px', position: 'relative' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12, marginBottom: 30 }}>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 13, color: '#64748b', marginTop: 4 }}>Stored locally in your browser for this demo</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <button type="submit" className="glow-btn" style={{ padding: '13px 24px', fontSize: 15, marginTop: 4 }} disabled={loading}>
